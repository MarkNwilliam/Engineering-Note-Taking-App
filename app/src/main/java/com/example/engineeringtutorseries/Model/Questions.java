...
public class Questions {
    ...
    public static final String TITLEJ = "Set_10";
    public static final String TITLEK = "Set_11";
    public static final String TITLEL = "Set_12";
    public static final String TITLEM = "Set_13";
    public static final String TITLEN = "Set_14";
    public static final String TITLEO = "Set_15";
    public static final String TITLEP = "Set_16";
